 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://example.org/", wsdlLocation = "http://localhost:8080/SOAP/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://example.org/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://example.org/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example.org/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
